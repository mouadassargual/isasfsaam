...
const speakers = [
  ...
  {
    id: "elmehdy-cherrat",
    name: "Pr El Mehdy Cherrat",
    roleEn: "Keynote Speaker",
    roleFr: "Conférencier Principal",
    organization: "University Professor",
    bioEn: "Distinguished professor bringing academic expertise and insights to the school.",
    bioFr: "Professeur distingué apportant son expertise académique et ses perspectives à l'école.",
    expertise: ["Research", "Academia", "Smart Systems"],
    image: null,
    initials: "EC",
  ...
  },
  {
    ...
    roleFr: "Conférencier Principal",
    organization: "University Professor",
    bioEn: "Renowned professor sharing expertise on cutting-edge technologies and research.",
    bioFr: "Professeur renommé partageant son expertise sur les technologies de pointe et la recherche.",
