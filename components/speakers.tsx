...
const speakers = [
  ...
  },
  {
    ...
    organization: "Smart Systems Expert",
    bioEn: "Smart systems expert leading round table discussions and workshops on data-based solutions.",
    bioFr: "Expert en systèmes intelligents animant des tables rondes et ateliers sur les solutions basées sur les données.",
  ...
  },
  {
    ...
    bioEn: "Data engineer building modern open-source data pipelines for analytics.",
    bioFr: "Ingénieur data construisant des pipelines de données open-source pour l'analytique.",
    expertise: ["Data Engineering", "Python", "Open Source"],
  ...
  },
  {
    ...
    bioEn: "Professor at ENA Meknès specializing in data science and open-source solutions.",
    bioFr: "Professeur à l'ENA Meknès spécialisé en data science et solutions open-source.",
  ...
  },
  {
    ...
    image: "/speakrs/abdellah-bourti.jpg",
      ...
      >
        <CardContent className="p-6">
          ...
          <div className="flex items-start gap-5 mb-5">
            {/* Photo */}
            <div className={cn(
              "relative shrink-0 w-28 h-28 rounded-2xl p-0.5 shadow-lg",
